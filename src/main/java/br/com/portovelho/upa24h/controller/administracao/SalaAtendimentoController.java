...
import br.com.portovelho.upa24h.enums.StatusSalaAtendimento;
...
import br.com.portovelho.upa24h.service.SalaAtendimentoService;
...
public class SalaAtendimentoController {
	...
	public ModelAndView listaSalaAtendimentos(@ModelAttribute("filtro") SalaAtendimentoFiltro filtro) {
		...
		mv.addObject("salaAtendimentos", salaAtendimentoRepository.filtrar(filtro));
		return mv;
	}
